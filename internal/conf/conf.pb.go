...
type Server struct {
	...
	Password *Server_PassWord `protobuf:"bytes,4,opt,name=password,proto3" json:"password,omitempty"`
}
...
func (x *Server) GetPassword() *Server_PassWord {
	if x != nil {
		return x.Password
	}
	return nil
...
type Server_JWT struct {
	...
	WhitePath []string `protobuf:"bytes,2,rep,name=whitePath,proto3" json:"whitePath,omitempty"`
}
...
func (x *Server_JWT) GetSecretKey() string {
	if x != nil {
		return x.SecretKey
	}
	return ""
...
func (x *Server_JWT) GetWhitePath() []string {
	if x != nil {
		return x.WhitePath
	}
	return nil
...
func (x *Server_PassWord) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Server_PassWord) ProtoMessage() {}

func (x *Server_PassWord) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Server_PassWord.ProtoReflect.Descriptor instead.
func (*Server_PassWord) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{1, 3}
}

func (x *Server_PassWord) GetSecretKey() string {
	if x != nil {
		return x.SecretKey
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x69, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x88, 0x04, 0x0a,
	...
	0x65, 0x72, 0x2e, 0x4a, 0x57, 0x54, 0x52, 0x03, 0x6a, 0x77, 0x74, 0x12, 0x37, 0x0a, 0x08, 0x70,
	0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e,
	0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65,
	0x72, 0x2e, 0x50, 0x61, 0x73, 0x73, 0x57, 0x6f, 0x72, 0x64, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73,
	0x77, 0x6f, 0x72, 0x64, 0x1a, 0x69, 0x0a, 0x04, 0x48, 0x54, 0x54, 0x50, 0x12, 0x18, 0x0a, 0x07,
	...
	,
	...
	0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x42, 0x32, 0x5a, 0x30, 0x67, 0x69, 0x74, 0x68, 0x75,
	0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x68, 0x6c, 0x35, 0x34, 0x30, 0x2f, 0x6d, 0x79, 0x2d, 0x72,
	0x65, 0x61, 0x6c, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61,
